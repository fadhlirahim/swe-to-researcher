...
- **Teach to learn, then animate it.** A short explainer of something you just learned ("what backprop computes," "why FlashAttention saves memory") finds your gaps faster than any test. For a visual learner this is the highest-leverage ritual you have: after you *implement* a concept, build a 20 to 40 second animated explainer of it. Having to move the pieces on screen forces the understanding (it's how Grant Sanderson of 3Blue1Brown says he learns), and the clip doubles as your proof-of-understanding artifact for that phase, a "learn in public" post, and reps for the storytelling muscle. Tooling: the [LottieFiles motion-design skill](https://github.com/lottiefiles/motion-design-skill) (`npx skills add LottieFiles/motion-design-skill`) for the motion *craft* (timing, easing, choreography), plain SVG/CSS for simple concepts, and [Manim](https://www.manim.community/) (3Blue1Brown's own engine) when you need real math visualization like vector fields, gradients, and loss surfaces. The one rule: animate the thing *after* you've built it, never instead of building it. Publish these from Phase 1 on.
